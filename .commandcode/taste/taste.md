...
# code-style
- Fix all discovered errors immediately — do not defer them as "pre-existing" or out-of-scope. Follow motto_v2 §6: knowing about an issue is a mandate to fix it in the same session. Confidence: 0.72

# workflow
- Prefer complete end-to-end implementation over partial patchwork fixes. When a choice exists between a quick patch and a proper long-term solution, always choose the latter per motto_v2. Confidence: 0.68
