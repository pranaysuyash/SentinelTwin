  ...
  return (
    <div className="rounded-xl border border-[#1f2536] bg-[#0b0f17] p-2.5">
      <div className="mb-2 flex items-center justify-between">
        <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#6a748b]">Spec Import</span>
      </div>
      <div className="space-y-2">
        <textarea
          ...
          className="h-16 w-full resize-none rounded-md border border-[#24283a] bg-[#131722] p-2 text-[10px] text-[#e6ebf7] placeholder:text-[#4a5568] focus:border-blue-500/50 focus:outline-none"
        />
