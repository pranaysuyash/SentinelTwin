...
export function OrganizationManagerPanel({ open, onClose }: OrganizationManagerPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 p-4">
      <div className="flex max-h-[90vh] w-full max-w-2xl flex-col rounded-2xl border border-[#1f2637] bg-[#0b0f17] shadow-2xl">
        <div className="flex items-center justify-between border-b border-[#1f2637] px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-[#91a4c5]">Manage organizations, plans, and membership</div>
            </div>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg border border-[#2a3347] p-1.5 text-[#91a4c5] hover:border-red-400/30 hover:bg-red-500/10 hover:text-red-200"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          {activeOrg ? (
            <div className="mb-4 rounded-xl border border-sky-400/20 bg-sky-500/10 p-3">
              ...
              <div className="mt-2 text-[10px] leading-relaxed text-[#91a4c5]">
                {planTierDescriptions[activeOrg.plan]}
              </div>
              <div className="mt-2 text-[10px] leading-relaxed text-[#91a4c5]">
                {formatOrganizationQuotaSummary(activeOrg)}
              </div>
              <div className="mt-1 text-[10px] leading-relaxed text-[#91a4c5]">
          ...
          <div className="mb-3 flex items-center justify-between">
            <div className="text-[11px] uppercase tracking-[0.22em] text-[#7e8fb0]">
          ...
          {showCreateForm ? (
            <div className="mb-3 rounded-xl border border-[#1f2637] bg-[#0e1726] p-3">
              <div className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#7e8fb0]">Create Organization</div>
              <input
                value={createName}
              ...
              <div className="mt-2 flex items-center gap-2">
                <span className="text-[10px] text-[#7e8fb0]">Plan:</span>
                  ...
                  <button
                    ...
                    className={`rounded-lg border px-2.5 py-1 text-[10px] font-semibold ${
                      createPlan === plan
                        ...
                        : "border-[#2a3347] text-[#91a4c5] hover:border-sky-400/20"
                    }`}
                  >
                    {planTierLabels[plan]}
                  </button>
              ...
              <div className="mt-3 flex gap-2">
                ...
                <button
                  ...
                  className="rounded-lg border border-[#2a3347] px-3 py-1.5 text-[10px] text-[#91a4c5]"
                >
                  Cancel
                </button>
              </div>
                ...
                >
                  {isEditing ? (
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Building2 className="h-4 w-4 text-[#91a4c5]" />
                          <span className="text-sm font-semibold text-white">{org.name}</span>
                          <span className="rounded-full border border-[#2a3347] bg-white/[0.04] px-2 py-0.5 text-[9px] uppercase tracking-[0.12em] text-[#91a4c5]">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="rounded-lg border border-[#2a3347] p-1.5 text-[#91a4c5] hover:border-sky-400/20 hover:bg-sky-500/10 hover:text-sky-200"
                          ...
                          <button
                            ...
                            className="rounded-lg border border-[#2a3347] p-1.5 text-[#91a4c5] hover:border-red-400/20 hover:bg-red-500/10 hover:text-red-200"
                      ...
                      <div className="mt-1.5 flex items-center gap-3 text-[10px] text-[#7e8fb0]">
        ...
        <div className="border-t border-[#1f2637] px-5 py-3 text-[10px] text-[#7e8fb0]">
