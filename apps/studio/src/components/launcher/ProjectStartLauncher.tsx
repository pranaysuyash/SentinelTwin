...
export function ProjectStartLauncher({
  ...
  const primaryActions: ProjectStartOption[] = [
    ...
    },
    {
      ...
      badge: "Scan / Manual-assisted",
      title: "Scan site with phone photos",
      description: "Manual-assisted photo marking compiles into a canonical SecurityScene. Guided capture prep helps before review and compile.",
      tone: "emerald",
      status: "Preview",
      onClick: onScanSite,
    },
