  ...
  return (
    <section className="rounded-xl border border-[#1f2536] bg-[#0b0f17] p-3">
      <div className="flex items-center gap-2">
        <h3 className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[#8ea0bf]">Top Issues</h3>
        <ExplainBadge text="Prioritized findings by severity. Use focus and camera actions to inspect evidence in-scene." />
      </div>
      <div className="mt-2 space-y-2">
        {issues.length === 0 ? <div className="text-[10px] text-[#7384a5]">No open issues in current simulation.</div> : null}
