  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        className="flex h-7 w-7 items-center justify-center rounded-md border border-[#2a3650] bg-[#111721] text-[#8ea5cc] transition-colors hover:border-[#3a4d70] hover:text-white"
        title="Pan left"
      >
      ...
      <div className="flex flex-col items-center px-1.5">
        ...
        <span className="font-mono text-[10px] text-[#d2d9e8]">{Math.round(yawDeg)}°</span>
      </div>
      <button
        type="button"
        onClick={() => onYawChange(normalizeAngle(yawDeg + PAN_STEP_DEG))}
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <div className="flex flex-col items-center px-1.5">
        ...
        <span className="font-mono text-[10px] text-[#d2d9e8]">{Math.round(pitchDeg)}°</span>
      </div>
      <button
        type="button"
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <div className="flex flex-col items-center px-1.5">
        ...
        <span className="font-mono text-[10px] text-[#d2d9e8]">{Math.round(fovDeg)}°</span>
      </div>
      <button
        type="button"
