  ...
  return (
    ...
    >
      <div
        ...
        className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-[28px] border border-[#20273a] bg-[#0b0f17] shadow-2xl shadow-black/50"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#1f2536] px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.24em] text-[#7a86a0]">
          ...
          <button
            type="button"
            onClick={() => setOpen(false)}
            className="rounded-xl border border-[#22314b] bg-[#101725] p-2 text-[#7a86a0] transition-colors hover:border-[#31405a] hover:text-white"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-[22px] border border-dashed border-[#28334e] bg-[#0e1422] p-5 flex flex-col items-center justify-center text-center">
              ...
              <div className="mt-1 text-xs text-[#7e8aa4]">
            ...
            <div className="flex flex-col">
              <label className="text-xs font-semibold uppercase tracking-[0.16em] text-[#7a86a0] mb-2 flex items-center gap-1.5">
              ...
              <textarea
                ...
                className="flex-1 min-h-[140px] rounded-[22px] border border-[#22314b] bg-[#0b0f17] p-3 font-mono text-xs text-[#d7deed] placeholder-[#47536d] focus:border-emerald-400/40 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="rounded-[24px] border border-[#1f2536] bg-[#0e1422] p-5 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#7a86a0]">
                <Radio className="h-4 w-4 text-emerald-400" />
                Default Wall Material & RF Attenuation Penalty
              </div>
              <span className="text-[11px] text-[#7e8aa4]">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    defaultMaterial === opt.id
                      ...
                      : "border-[#22314b] bg-[#0b0f17] text-[#c7d0e4] hover:border-[#31405a]"
                  )}
                >
                  ...
                  <div className="mt-1.5 text-[10px] leading-relaxed text-[#7e8aa4]">
                    {opt.description}
                  </div>
                </button>
              ))}
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div>
                <label className="text-[11px] font-semibold uppercase tracking-wider text-[#7a86a0] block mb-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#22314b] bg-[#0b0f17] px-3 py-2 text-xs font-mono text-white focus:border-emerald-400/40 focus:outline-none"
                />
              </div>
              <div>
                <label className="text-[11px] font-semibold uppercase tracking-wider text-[#7a86a0] block mb-1">
          ...
          {parseResult && "error" in parseResult ? (
            ...
            <div className="rounded-[24px] border border-[#1f2536] bg-[#0e1422] p-5 space-y-4">
              ...
              {levels.length > 0 ? (
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected
                              ...
                              : "border-[#22314b] bg-[#0b0f17] text-[#7e8aa4]"
                          )}
                        >
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              ...
                              <div className="text-[10px] font-mono text-[#7e8aa4]">
                ...
                <div className="text-xs text-[#7e8aa4] italic">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between border-t border-[#1f2536] bg-[#090d14] px-6 py-4">
          <div className="text-xs text-[#7e8aa4]">
            {filteredScene ? (
              <span>
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => setOpen(false)}
              className="rounded-xl border border-[#22314b] bg-[#101725] px-4 py-2 text-xs font-semibold text-[#c7d0e4] hover:border-[#31405a] hover:text-white transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className={cn(
                ...
                filteredScene
                  ...
                  : "border-[#22314b] bg-[#111622] text-[#4d5973] cursor-not-allowed"
              )}
            >
