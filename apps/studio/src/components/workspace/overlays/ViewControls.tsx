  ...
  return (
    <div className="absolute right-3 top-16 z-10 flex flex-col gap-1">
      ...
      <button
        ...
        className={`flex h-8 w-8 items-center justify-center rounded-lg border ${UI_SURFACES.borderDark} ${UI_SURFACES.bgDeep}/90 text-[7px] font-bold tracking-wide text-[#9aa8c4] transition-colors ${UI_SURFACES.hoverBgMuted} ${UI_SURFACES.hoverText}`}
      >
        ...
        className={cn(
          "flex h-8 w-8 items-center justify-center rounded-lg border text-[9px] font-bold transition-colors",
           canvasMode === "orbit_3d"
             ...
             : "${UI_SURFACES.borderDark} ${UI_SURFACES.bgDeep}/90 text-[#6b7280] ${UI_SURFACES.hoverBgMuted} ${UI_SURFACES.hoverText}",
        )}
