  ...
  test("derives a four-part executive summary from outcome data", () => {
    const outcome = {
      ...
      scorecard: {
        ...
        dimensions: {
          coverage: { score: 0, label: "No data" },
          zoneCompliance: { score: 0, label: "No data", passing: 0, total: 0 },
          redundancy: { score: 0, label: "No data" },
          nightReadiness: { score: 0, label: "No data" },
          pathVisibility: { score: 0, label: "No data" },
          privacy: { score: 0, label: "No data" },
        },
      },
      causeTaxonomy: [],
      assumptions: [],
