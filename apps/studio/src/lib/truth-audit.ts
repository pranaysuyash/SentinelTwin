...
export const TRUST_AUDIT_SURFACES: TrustAuditSurface[] = [
  ...
  },
  {
    ...
    requiredPhrases: [
      ...
      "Guided scan assistant opened. The manual-assisted review and compile flow remains in control.",
      "open the guided scan assistant",
    ],
    forbiddenPhrases: ["Coming Soon", "fake", "stub"],
  },
  {
  ...
  {
    surface: "Workspace catalog boundary",
