...
export const TRUST_AUDIT_SURFACES: TrustAuditSurface[] = [
  {
    ...
    requiredPhrases: [
      "Preview / Manual-assisted",
      "Manual-assisted photo marking compiles into a canonical SecurityScene. A guided assistant now helps capture prep before review and compile.",
    ],
