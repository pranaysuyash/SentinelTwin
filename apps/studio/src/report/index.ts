...
<body>
  ...
  <p>
    This is a planning-oriented estimate and not a legal or certified compliance ruling.
  </p>
...
export function exportAsMarkdown(report: ReportData): string {
  const lines = [
    ...
    "This report is planning-grade and does not confer legal certification.",
    "",
    `---`,
