import type { DoriQuality, SecurityScene } from "@/schema/security-scene";
import { createCoverageEvaluator, getIdentificationAreaPct, getRecognitionAreaPct } from "@/simulation/coverage";
