...
const KNOWN_GENERATED_PATTERNS: Array<{ pattern: RegExp; suggestedIgnore: string; reason: string }> = [
  ...
  {
    pattern: /^experiments\/scene_understanding\/outputs\/semantic_tasks\//,
    suggestedIgnore: "experiments/scene_understanding/outputs/semantic_tasks/",
    reason: "semantic task evaluation outputs",
  },
  ...
  { pattern: /^novel-.*\.png$/i, suggestedIgnore: "novel-*.png", reason: "novel panel screenshot captures" },
